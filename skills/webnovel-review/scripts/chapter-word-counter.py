...
输出：自动保存到 .webnovel/review/word-count-report.json 和 .webnovel/review/word-count-report.md
"""
...
def generate_report(analysis_result: Dict, output_dir: str = ".webnovel/review") -> None:
    """生成统计报告"""
...
def main():
    ...
    parser.add_argument('--output', '-o', default='.webnovel/review/',
                        help='报告输出目录 (默认: .webnovel/review/)')
